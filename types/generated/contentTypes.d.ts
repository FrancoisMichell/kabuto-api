...
export interface ApiAcademiaAcademia extends Struct.CollectionTypeSchema {
  collectionName: 'academias';
  info: {
    displayName: 'Academia';
    pluralName: 'academias';
    singularName: 'academia';
  };
  options: {
  ...
  attributes: {
    ...
    instrutores: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiInstrutorInstrutor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academias: Schema.Attribute.Relation<
      'manyToMany',
      'api::academia.academia'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Faixa: Schema.Attribute.Enumeration<['Verde', 'Azul', 'Marrom', 'Preta ']> &
      Schema.Attribute.Required &
...
export interface ApiTurmaTurma extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academia: Schema.Attribute.Relation<'manyToOne', 'api::academia.academia'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Detalhes: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Required;
    Duracao: Schema.Attribute.Enumeration<
      [
        'Dura\u00E7\u00E3o: 01h',
        'Dura\u00E7\u00E3o: 01:30h',
        'Dura\u00E7\u00E3o: 02h',
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Dura\u00E7\u00E3o: 01h'>;
    Hora: Schema.Attribute.Time & Schema.Attribute.Required;
    instrutor: Schema.Attribute.Relation<
      'manyToOne',
      'api::instrutor.instrutor'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
